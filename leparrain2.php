...
$data_profile = $profile->fetch();
    ...
    $com = $bdd->prepare('SELECT * FROM commande WHERE ncom BETWEEN 26 AND 50 ');
    $com->execute();
        ...
        <div class="pagnation">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    <li class="page-item "><a class="page-link" href="leparrain.php">1</a></li>                   
                    <li class="page-item active"><a class="page-link" href="leparrain2.php">2</a></li>
