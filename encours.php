...
$email = ($_SESSION['user']);
    ...
    $com = $bdd->prepare("SELECT * FROM commande WHERE etat ='En cours' AND ncom < 26 ");
    $com->execute();
    ...
    <div class="container col-md-10 ">
        ...
        <div class="pagnation">
            <nav aria-label="...">
                <ul class="pagination">
                    <li class="page-item ">
                        <a class="page-link" href="encours.php">Début</a>
                    </li>
                    <li class="page-item active"><a class="page-link" href="encours.php">1</a></li>
                    <span class="sr-only">(current)</span>
                    <li class="page-item">
                        <a class="page-link" href="encours.php">Fin</a>
                    </li>
                </ul>
