...
$email = ($_SESSION['user']);
    ...
    $com = $bdd->prepare("SELECT * FROM commande WHERE etat ='Livré' OR etat='Livré Payé' AND ncom BETWEEN 36 AND 70  ");
    $com->execute();
        ...
        <div class="pagnation">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    <li class="page-item active"><a class="page-link" href="liv2.php">2</a></li>
                    <li class="page-item "><a class="page-link" href="liv3.php">3</a></li>
                    <li class="page-item">
