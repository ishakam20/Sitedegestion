...
if(!isset($_SESSION['user']))
{
    ...
    $email = ($_SESSION['user']);
    $profile = $bdd->prepare('SELECT * FROM comptes WHERE email = ? ');
    $profile->execute(array($email));
    $data_profile = $profile->fetch();

    $com = $bdd->prepare('SELECT * FROM commande WHERE ncom < 26 ');
    $com->execute();
    $data_com = $com->fetchAll();
...
<body>
    ...
    <?php 
        if(isset( $_GET['depot']) && $_GET['depot']==='oui')
            {
            echo "<div class=\"alert alert-success\" role=\"alert\">  La commande a bien été ajouté !</div>";
            }elseif(isset( $_GET['depot']) && $_GET['depot']==='non') {
                echo "<div class=\"alert alert-danger\" role=\"alert\">  La commande n'a pas été ajouté!</div>";

            }

        if(isset( $_GET['modif']) && $_GET['modif']==='oui')
            {
            echo "<div class=\"alert alert-success\" role=\"alert\">  La commande a bien été modifié !</div>";
            }elseif(isset( $_GET['depot']) && $_GET['depot']==='non') {
                echo "<div class=\"alert alert-danger\" role=\"alert\">  La commande n'a pas été modifié!</div>";

            }
        if(isset( $_GET['supp']) && $_GET['supp']==='oui')
            {
            echo "<div class=\"alert alert-success\" role=\"alert\">  La commande a bien été supprimé !</div>";
            }elseif(isset( $_GET['supp']) && $_GET['supp']==='non') {
                echo "<div class=\"alert alert-danger\" role=\"alert\">  La commande n'a pas été supprimé!</div>";
    ...
    <div class="container col-md-10 ">
        ...
        <div class="pagnation">
            <nav aria-label="...">
                <ul class="pagination">
                    <li class="page-item ">
                        <a class="page-link" href="leparrain.php">Début</a>
                    </li>
                    <li class="page-item active"><a class="page-link" href="leparrain.php">1</a></li>
                    <span class="sr-only">(current)</span>
                    <li class="page-item"><a class="page-link" href="leparrain2.php">2</a></li>
                    <li class="page-item"><a class="page-link" href="leparrain3.php">3</a></li>
                    <li class="page-item "><a class="page-link" href="leparrain4.php">4</a></li>
                    <li class="page-item "><a class="page-link" href="leparrain5.php">5</a></li>
                    <li class="page-item "><a class="page-link" href="leparrain6.php">6</a></li>
                    <li class="page-item "><a class="page-link" href="leparrain7.php">7</a></li>
                    <li class="page-item "><a class="page-link" href="leparrain8.php">8</a></li>
                    <li class="page-item "><a class="page-link" href="leparrain9.php">9</a></li>
                    <li class="page-item "><a class="page-link" href="leparrain10.php">10</a></li>
                    <li class="page-item">
                        <a class="page-link" href="leparrain10.php">Fin</a>
                    </li>
                </ul>
                ...
                <div class="modal-body ">
                    <div class="commande ">
                        <div class="form-group col-md-12 ">
                            ...
                            <div class="col-sm-12 ">
                                <textarea type="text"  class="form-control form-control-line" disabled><?php echo $d1['commentaire1']?> </textarea>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
                ...
                <form method="POST" action="modif.php?id=<?=$d['ncom']?>">
                    <div class="commande ">
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <?php if($data_profile['role'] == 'administrateur') {?>
                            ...
                            <?php }else { ?>
                                <div class="form-group col-md-6 ">
                                <label class="col-sm-12 ">Statut de la commande </label>
                                <texteare type="text" placeholder="Statut" class="form-control form-control-line" disabled> <?php echo $d['etat']?> </texteare>
                            </div>  
                            <?php } ?>
                        </div>
                        <hr>
