...
require_once 'db.php';
    ...
    $com = $bdd->prepare("SELECT * FROM commande WHERE etat ='En cours' AND ncom BETWEEN 26 AND 50");
    $com->execute();
        ...
        <div class="pagnation">
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    <li class="page-item "><a class="page-link" href="encours.php">1</a></li>
                    <li class="page-item active"><a class="page-link" href="encours2.php">2</a></li>
                    <span class="sr-only">(current)</span>
                    <li class="page-item">
                        <a class="page-link" href="encours2.php">Fin</a>
                    </li>
                </ul>
