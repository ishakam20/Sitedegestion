...
$email = ($_SESSION['user']);
    ...
    $com = $bdd->prepare("SELECT * FROM commande WHERE etat ='Livré' OR etat='Livré Payé' AND ncom BETWEEN 71 AND 105   ");
    $com->execute();
    ...
    <nav class="navbar navbar-expand-lg  ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="height: 100px;">
            ...
            <form class="form-inline my-10my-lg-0">
                <a class="form-control mr-sm-2" href="" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle" aria-hidden="true" ></i></a>            </form>
        </div>
    </nav>
    <div class="container col-md-10 ">
        ...
        <div class="pagnation">
            <nav aria-label="...">
                <ul class="pagination">
                    <li class="page-item ">
                        <a class="page-link" href="liv.php">Début</a>
                    </li>
                    <li class="page-item "><a class="page-link" href="liv.php">1</a></li>
                    <li class="page-item"><a class="page-link" href="liv2.php">2</a></li>
                    <li class="page-item active"><a class="page-link" href="liv3.php">3</a></li>
                    <li class="page-item">
                        <a class="page-link" href="liv3.php">Fin</a>
                    </li>
                </ul>
