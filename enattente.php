...
$email = ($_SESSION['user']);
    ...
    $com = $bdd->prepare("SELECT * FROM commande WHERE etat ='En attente' ");
    $com->execute();
    ...
    <div class="container col-md-10 ">
        ...
        <div class="pagnation">
            <nav aria-label="...">
                <ul class="pagination">
                    <li class="page-item ">
                        <a class="page-link" href="enattente.php">Début</a>
                    </li>
                    <li class="page-item active"><a class="page-link" href="enattente.php">1</a></li>
                    <span class="sr-only">(current)</span>
                    <li class="page-item">
                        <a class="page-link" href="enattente.php">Fin</a>
                    </li>
                </ul>
