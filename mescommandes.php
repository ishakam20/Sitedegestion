...
$prénom = $data_profile['prénom'];

$com = $bdd->prepare("SELECT * FROM commande WHERE agent = '$prénom' ");
$com->execute();
    ...
    <div class="container col-md-10 ">
        ...
        <div class="pagnation">
            <nav aria-label="...">
                <ul class="pagination">
                    <li class="page-item ">
                        <a class="page-link" href="mescommandes.php">Début</a>
                    </li>
                    <li class="page-item active"><a class="page-link" href="mescommandes.php">1</a></li>
                    <span class="sr-only">(current)</span>
                    <li class="page-item">
                        <a class="page-link" href="mescommandes.php">Fin</a>
                    </li>
                </ul>
            ...
            <div class="modal-content ">
                ...
                <form method="POST" action="modif.php?id=<?=$d['ncom']?>">
                    ...
                    <div class="produit ">
                        ...
                        <div class="form-group row ">
                            <div class="form-group col-md-12 ">
                                <label class="col-sm-12 ">Produit + taille
                                </label>
                                <div class="col-sm-12 ">
